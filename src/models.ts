...
export const WeatherInputSchema = z.object({
  ...
  include_hourly: z.boolean().default(true).describe("Include hourly forecast data"),
  timezone: z
    .string()
    .min(1)
    .default("auto")
    .describe("Timezone for timestamps (e.g., 'Europe/Zurich', 'auto')")
...
export const SnowInputSchema = z.object({
  ...
  timezone: z
    ...
    .describe("Timezone for timestamps")
    .refine((val) => val.trim().length > 0, {
      message: "Timezone cannot be empty",
    }),
});
...
export const HourlyWeatherSchema = z.object({
  ...
  temperature_2m: z.array(z.number()).default([]).describe("Temperature at 2m height (°C)"),
  apparent_temperature: z
    .array(z.number())
    .optional()
    .describe("Apparent temperature / feels like (°C)"),
  ...
  weather_code: z.array(z.number().int()).default([]).describe("WMO weather codes"),
  wind_speed_10m: z.array(z.number()).default([]).describe("Wind speed at 10m (km/h)"),
  wind_gusts_10m: z.array(z.number()).optional().describe("Wind gusts at 10m (km/h)"),
  relative_humidity_2m: z.array(z.number().int()).optional().describe("Relative humidity (%)"),
...
export const DailyWeatherSchema = z.object({
  ...
  temperature_2m_max: z.array(z.number()).default([]).describe("Maximum temperature (°C)"),
  temperature_2m_min: z.array(z.number()).default([]).describe("Minimum temperature (°C)"),
  precipitation_sum: z.array(z.number()).default([]).describe("Total precipitation (mm)"),
  precipitation_probability_max: z
    .array(z.number().int())
    .optional()
    .describe("Maximum precipitation probability (%)"),
  precipitation_hours: z.array(z.number()).optional().describe("Hours with precipitation"),
  weather_code: z.array(z.number().int()).default([]).describe("WMO weather codes"),
  ...
  wind_speed_10m_max: z.array(z.number()).optional().describe("Maximum wind speed (km/h)"),
  wind_gusts_10m_max: z.array(z.number()).optional().describe("Maximum wind gusts (km/h)"),
});
...
export const WeatherForecastSchema = z.object({
  ...
  timezone_abbreviation: z.string().optional().describe("Timezone abbreviation"),
  utc_offset_seconds: z.number().int().optional().describe("UTC offset in seconds"),
  current_weather: CurrentWeatherSchema.optional().describe("Current weather conditions"),
...
export const HourlySnowSchema = z.object({
  time: z.array(z.string()).default([]).describe("Timestamps for each hour"),
  temperature_2m: z.array(z.number()).default([]).describe("Temperature at 2m (°C)"),
  apparent_temperature: z
    .array(z.number())
    .optional()
    .describe("Apparent temperature / wind chill (°C)"),
  snowfall: z.array(z.number()).default([]).describe("Snowfall amount (cm)"),
  snow_depth: z.array(z.number()).default([]).describe("Snow depth (m)"),
  weather_code: z.array(z.number().int()).default([]).describe("WMO weather codes"),
  wind_speed_10m: z.array(z.number()).optional().describe("Wind speed at 10m (km/h)"),
  wind_gusts_10m: z.array(z.number()).optional().describe("Wind gusts at 10m (km/h)"),
  cloud_cover: z.array(z.number().int()).optional().describe("Cloud cover (%)"),
  precipitation_probability: z
    .array(z.number().int())
...
export const DailySnowSchema = z.object({
  ...
  snow_depth_max: z.array(z.number()).optional().describe("Maximum snow depth (m)"),
  precipitation_probability_max: z
    .array(z.number().int())
    .optional()
    .describe("Maximum precipitation probability (%)"),
...
export const GeocodingResultSchema = z.object({
  ...
  admin2: z.string().optional().describe("Second-level administrative division"),
  admin3: z.string().optional().describe("Third-level administrative division"),
  admin4: z.string().optional().describe("Fourth-level administrative division"),
...
export const GeocodingResponseSchema = z.object({
  results: z.array(GeocodingResultSchema).optional().describe("List of matching locations"),
  generationtime_ms: z.number().optional().describe("API generation time in milliseconds"),
});
...
export const CurrentAirQualitySchema = z.object({
  ...
  european_aqi: z.number().int().optional().describe("European Air Quality Index (0-100+)"),
  us_aqi: z.number().int().optional().describe("United States Air Quality Index (0-500)"),
...
export const HourlyAirQualitySchema = z.object({
  time: z.array(z.string()).default([]).describe("Timestamps for each hour"),
  european_aqi: z.array(z.number().int()).optional().describe("European Air Quality Index"),
  us_aqi: z.array(z.number().int()).optional().describe("United States Air Quality Index"),
  pm10: z.array(z.number()).optional().describe("Particulate matter PM10 (μg/m³)"),
  pm2_5: z.array(z.number()).optional().describe("Particulate matter PM2.5 (μg/m³)"),
  carbon_monoxide: z.array(z.number()).optional().describe("Carbon monoxide (μg/m³)"),
  nitrogen_dioxide: z.array(z.number()).optional().describe("Nitrogen dioxide (μg/m³)"),
  sulphur_dioxide: z.array(z.number()).optional().describe("Sulphur dioxide (μg/m³)"),
  ozone: z.array(z.number()).optional().describe("Ozone (μg/m³)"),
  dust: z.array(z.number()).optional().describe("Dust (μg/m³)"),
  uv_index: z.array(z.number()).optional().describe("UV index"),
  uv_index_clear_sky: z.array(z.number()).optional().describe("UV index under clear sky"),
  ammonia: z.array(z.number()).optional().describe("Ammonia (μg/m³)"),
  alder_pollen: z.array(z.number()).optional().describe("Alder pollen (grains/m³)"),
  birch_pollen: z.array(z.number()).optional().describe("Birch pollen (grains/m³)"),
  grass_pollen: z.array(z.number()).optional().describe("Grass pollen (grains/m³)"),
  mugwort_pollen: z.array(z.number()).optional().describe("Mugwort pollen (grains/m³)"),
  olive_pollen: z.array(z.number()).optional().describe("Olive pollen (grains/m³)"),
  ragweed_pollen: z.array(z.number()).optional().describe("Ragweed pollen (grains/m³)"),
});
...
export const AirQualityForecastSchema = z.object({
  ...
  hourly: HourlyAirQualitySchema.optional().describe("Hourly air quality forecast"),
});
...
export const HourlyMarineSchema = z.object({
  ...
  wave_direction: z.array(z.number().int()).optional().describe("Wave direction (degrees)"),
  wave_period: z.array(z.number()).optional().describe("Wave period (seconds)"),
  wind_wave_height: z.array(z.number()).optional().describe("Wind wave height (m)"),
  wind_wave_direction: z
    .array(z.number().int())
    .optional()
    .describe("Wind wave direction (degrees)"),
  wind_wave_period: z.array(z.number()).optional().describe("Wind wave period (seconds)"),
  swell_wave_height: z.array(z.number()).optional().describe("Swell wave height (m)"),
  swell_wave_direction: z
    .array(z.number().int())
    .optional()
    .describe("Swell wave direction (degrees)"),
  swell_wave_period: z.array(z.number()).optional().describe("Swell wave period (seconds)"),
});
...
export const DailyMarineSchema = z.object({
  time: z.array(z.string()).default([]).describe("Dates for each day"),
  wave_height_max: z.array(z.number()).optional().describe("Maximum wave height (m)"),
  wave_direction_dominant: z
    .array(z.number().int())
    .optional()
    .describe("Dominant wave direction (degrees)"),
  wave_period_max: z.array(z.number()).optional().describe("Maximum wave period (seconds)"),
  swell_wave_height_max: z.array(z.number()).optional().describe("Maximum swell wave height (m)"),
  swell_wave_direction_dominant: z
    .array(z.number().int())
    .optional()
    .describe("Dominant swell wave direction (degrees)"),
  swell_wave_period_max: z
    .array(z.number())
    .optional()
    .describe("Maximum swell wave period (seconds)"),
});
...
export const WeatherAlertSchema = z.object({
  type: z.string().describe("Alert type: storm, heat, cold, uv, wind, air_quality"),
  ...
  recommendations: z.array(z.string()).default([]).describe("Safety recommendations"),
});
...
export const WeatherAlertsResponseSchema = z.object({
  ...
  longitude: z.number().describe("Longitude of the location"),
  timezone: z.string().describe("Timezone name"),
  alerts: z.array(WeatherAlertSchema).default([]).describe("List of active alerts"),
});
